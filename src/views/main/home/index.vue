<template>
  <div class="box">
        ...
        <el-card class="box-card">
          <template #header>
            <div class="card-header">
              <span>设备ID:{{ o.id }}</span>
              <el-button v-if="o.type === '六面扫系统'" type="text" class="open-btn" @click="openData(o,x)">
                数据
              </el-button>
              <el-button type="text" class="open-btn" @click="operate(o,x)">
                操作
              </el-button>
            </div>
          </template>
    ...
    <el-dialog v-model="data.showCard" :with-header="false" center>
      <div class="dialog-box" v-loading="data.showLoading">
